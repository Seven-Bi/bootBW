...
window.addEventListener("load", function() {
	var ctx = document.getElementById('header_canvas').getContext('2d');
	//gradient
	var options =
	{
		resolution: 1,
	...
	var colorPoints = [
		new ColorPoint(0, 0, new Color(255, 255, 255)),
		new ColorPoint(0, 1, new Color(255, 255, 255)),
		new ColorPoint(1, 0, new Color(255, 255, 255)),
		new ColorPoint(1, 1, new Color(255,255, 255))
	];
